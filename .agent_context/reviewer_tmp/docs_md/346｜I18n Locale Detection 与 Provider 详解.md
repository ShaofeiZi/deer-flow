...
| 重点代码 | `frontend/src/core/i18n/server.ts`、`frontend/src/core/i18n/locale.ts`、`frontend/src/core/i18n/context.tsx`、`frontend/src/core/i18n/hooks.ts`、`frontend/src/app/layout.tsx`、`frontend/src/components/workspace/settings/appearance-settings-page.tsx`。 |
...
| 用户切换 | `frontend/src/components/workspace/settings/appearance-settings-page.tsx` | Select 调 `changeLocale()`，更新 React context 并写 cookie。 |
