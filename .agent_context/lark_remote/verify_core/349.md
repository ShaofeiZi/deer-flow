...
| 学习阶段 | 先读章节 | 对应源码 | 验收输出 |
|-|-|-|-|
| 前端入口和聊天 UI | 06、42、50、58、100、112、129、355 | `frontend/src/app/workspace/*`、`frontend/src/components/workspace/*`、`frontend/src/core/threads/*` | 能画出 `InputBox -> use-thread-chat -> LangGraph SDK -> MessageList`。 |
